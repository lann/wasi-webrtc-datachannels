...
// Options used:
//   * std_feature
//   * type_section_suffix: "rust-wasip3-0.7.0+wasi-0.3.0-from-crates-io"
#[rustfmt::skip]
    ...
    pub mod cli {
        ...
        pub mod environment {
            ...
            pub fn get_environment() -> _rt::Vec<(_rt::String, _rt::String)> {
                unsafe {
                    ...
                    #[link(wasm_import_module = "wasi:cli/environment@0.3.0")]
                    unsafe extern "C" {
        ...
        pub mod exit {
            ...
            pub fn exit(status: Result<(), ()>) -> () {
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "wasi:cli/exit@0.3.0")]
                    unsafe extern "C" {
                        #[link_name = "exit"]
            ...
            pub fn exit_with_code(status_code: u8) -> () {
                unsafe {
                    ...
                    wit_import0(_rt::as_i32(&status_code));
                }
            }
        }
        #[allow(dead_code, async_fn_in_trait, unused_imports, clippy::all)]
        ...
        pub mod stdin {
            ...
            pub fn read_via_stream() -> (
                ...
                unsafe {
                    ...
                    let ptr0 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "wasi:cli/stdin@0.3.0")]
                    unsafe extern "C" {
        ...
        pub mod stdout {
            ...
            pub fn write_via_stream(
                ...
                unsafe {
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "wasi:cli/stdout@0.3.0")]
                    unsafe extern "C" {
        ...
        pub mod stderr {
            ...
            pub fn write_via_stream(
                ...
                unsafe {
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "wasi:cli/stderr@0.3.0")]
                    unsafe extern "C" {
                        #[link_name = "write-via-stream"]
                        fn wit_import0(_: i32) -> i32;
                    }
        ...
        pub mod terminal_input {
            ...
            unsafe impl _rt::WasmResource for TerminalInput {
                ...
                unsafe fn drop(_handle: u32) {
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "wasi:cli/terminal-input@0.3.0")]
                    unsafe extern "C" {
        ...
        pub mod terminal_output {
            ...
            unsafe impl _rt::WasmResource for TerminalOutput {
                ...
                unsafe fn drop(_handle: u32) {
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "wasi:cli/terminal-output@0.3.0")]
                    unsafe extern "C" {
        ...
        pub mod terminal_stdin {
            ...
            pub fn get_terminal_stdin() -> Option<TerminalInput> {
                unsafe {
                    ...
                    let ptr0 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "wasi:cli/terminal-stdin@0.3.0")]
                    unsafe extern "C" {
        ...
        pub mod terminal_stdout {
            ...
            pub fn get_terminal_stdout() -> Option<TerminalOutput> {
                unsafe {
                    ...
                    let ptr0 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "wasi:cli/terminal-stdout@0.3.0")]
                    unsafe extern "C" {
        ...
        pub mod terminal_stderr {
            ...
            pub fn get_terminal_stderr() -> Option<TerminalOutput> {
                unsafe {
                    ...
                    let ptr0 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "wasi:cli/terminal-stderr@0.3.0")]
                    unsafe extern "C" {
                ...
                unsafe {
                    ...
                    unsafe impl<'a> _Subtask for _MySubtask<'a> {
                        ...
                        unsafe fn call_import(
                            ...
                            #[cfg(target_arch = "wasm32")]
                            #[link(
                                wasm_import_module = "wasi:clocks/monotonic-clock@0.3.0"
                            )]
                            unsafe extern "C" {
        ...
        pub mod system_clock {
            ...
            pub fn now() -> Instant {
                unsafe {
                    ...
                    let ptr0 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "wasi:clocks/system-clock@0.3.0")]
                    unsafe extern "C" {
                        #[link_name = "now"]
                        fn wit_import1(_: *mut u8);
                    }
        ...
        pub mod insecure {
            ...
            pub fn get_insecure_random_bytes(max_len: u64) -> _rt::Vec<u8> {
                unsafe {
                    ...
                    let ptr0 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "wasi:random/insecure@0.3.0")]
                    unsafe extern "C" {
        ...
        pub mod insecure_seed {
            ...
            pub fn get_insecure_seed() -> (u64, u64) {
                unsafe {
                    ...
                    let ptr0 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "wasi:random/insecure-seed@0.3.0")]
                    unsafe extern "C" {
                ...
                unsafe {
                    ...
                    unsafe impl<'a> _Subtask for _MySubtask<'a> {
                        ...
                        unsafe fn call_import(
                            ...
                            #[cfg(target_arch = "wasm32")]
                            #[link(
                                wasm_import_module = "wasi:sockets/ip-name-lookup@0.3.0"
                            )]
                            unsafe extern "C" {
...
#[rustfmt::skip]
#[cfg(target_arch = "wasm32")]
#[cfg_attr(feature = "rustc-dep-of-std", unsafe(link_section = "component-type:wit-bindgen:0.59.0:wasi:cli@0.3.0:imports:encoded worldrust-wasip3-0.7.0+wasi-0.3.0-from-crates-io-in-libstd"))]
#[cfg_attr(not(feature = "rustc-dep-of-std"), unsafe(link_section = "component-type:wit-bindgen:0.59.0:wasi:cli@0.3.0:imports:encoded worldrust-wasip3-0.7.0+wasi-0.3.0-from-crates-io"))]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 7891] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xd5<\x01A\x02\x01A1\x01\
...
\0\x1fwasi:random/insecure-seed@0.3.0\x05\x1b\x04\0\x16wasi:cli/imports@0.3.0\x04\
\0\x0b\x0d\x01\0\x07imports\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dw\
it-component\x070.253.0\x10wit-bindgen-rust\x060.59.0";
#[inline(never)]
#[doc(hidden)]
