...
//   * type_section_suffix: "rust-wasip3-0.7.0+wasi-0.3.0-from-crates-io-service-world"
            ...
            impl ::core::fmt::Debug for HeaderError {
                fn fmt(
                    ...
                    match self {
                        ...
                        HeaderError::SizeExceeded => {
                            f.debug_tuple("HeaderError::SizeExceeded").finish()
                        }
                        HeaderError::Other(e) => {
                            f.debug_tuple("HeaderError::Other").field(e).finish()
                        }
                    }
                }
            }
            ...
            impl ::core::fmt::Debug for RequestOptionsError {
                fn fmt(
                    ...
                    match self {
                        ...
                        RequestOptionsError::Other(e) => {
                            f.debug_tuple("RequestOptionsError::Other").field(e).finish()
                        }
                    }
                }
            }
                            ...
                            1 => {
                                let e = {
                                    ...
                                    let v9 = match l4 {
                                        ...
                                        1 => RequestOptionsError::Immutable,
                                        n => {
                                            debug_assert_eq!(n, 2, "invalid enum discriminant");
                                            let e9 = {
                                                let l5 = i32::from(
                ...
                unsafe {
                    ...
                    unsafe impl<'a> _Subtask for _MySubtask<'a> {
                        ...
                        unsafe fn call_import(
                            ...
                            #[cfg(target_arch = "wasm32")]
                            #[link(wasm_import_module = "wasi:http/client@0.3.0")]
                            unsafe extern "C" {
    ...
    pub mod wasi {
        pub mod http {
            ...
            pub mod handler {
                ...
                pub unsafe fn _export_handle_cabi<T_: Guest>(arg0: i32) -> i32 {
                    unsafe {
                        ...
                        wit_bindgen::rt::async_support::start_task(async move {
                            ...
                            #[cfg(target_arch = "wasm32")]
                            #[link(
                                wasm_import_module = "[export]wasi:http/handler@0.3.0"
                            )]
                            unsafe extern "C" {
                ...
                #[doc(hidden)]
                #[macro_export]
                macro_rules! __export_wasi_http_handler_0_3_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "[async-lift]wasi:http/handler@0.3.0#handle")] unsafe extern "C"
                        fn export_handle(arg0 : i32,) -> i32 { unsafe {
                        $($path_to_types)*:: _export_handle_cabi::<$ty > (arg0) } }
                        #[unsafe (export_name =
                        "[callback][async-lift]wasi:http/handler@0.3.0#handle")] unsafe
                        extern "C" fn _callback_handle(event0 : u32, event1 : u32, event2
                        : u32) -> u32 { unsafe { $($path_to_types)*::
                        __callback_handle(event0, event1, event2) } } };
                    };
                }
                #[doc(hidden)]
                pub use __export_wasi_http_handler_0_3_0_cabi;
            }
        }
    }
}
...
pub mod wit_future {
    ...
    pub mod vtable0 {
        ...
        > {
            ...
            drop_readable,
            dealloc_lists,
            layout: unsafe { ::core::alloc::Layout::from_size_align_unchecked(40, 8) },
            lift,
            lower,
            new,
            start_read,
...
macro_rules! __export_service_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::wasi::http::handler::__export_wasi_http_handler_0_3_0_cabi!($ty
        ...
        "component-type:wit-bindgen:0.59.0:wasi:http@0.3.0:service:imports and exportsrust-wasip3-0.7.0+wasi-0.3.0-from-crates-io-service-world")]
        #[doc(hidden)] #[allow(clippy::octal_escapes)] pub static
        __WIT_BINDGEN_COMPONENT_TYPE : [u8; 4995] = *
        b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x85&\x01A\x02\x01A\x1f\
\x01B\x02\x01m\x03\x02io\x15illegal-byte-sequence\x04pipe\x04\0\x0aerror-code\x03\
\0\0\x03\0\x14wasi:cli/types@0.3.0\x05\0\x02\x03\0\0\x0aerror-code\x01B\x07\x02\x03\
\x02\x01\x01\x04\0\x0aerror-code\x03\0\0\x01f\x01}\x01j\0\x01\x01\x01e\x01\x03\x01\
@\x01\x04data\x02\0\x04\x04\0\x10write-via-stream\x01\x05\x03\0\x15wasi:cli/stdo\
ut@0.3.0\x05\x02\x01B\x07\x02\x03\x02\x01\x01\x04\0\x0aerror-code\x03\0\0\x01f\x01\
}\x01j\0\x01\x01\x01e\x01\x03\x01@\x01\x04data\x02\0\x04\x04\0\x10write-via-stre\
am\x01\x05\x03\0\x15wasi:cli/stderr@0.3.0\x05\x03\x01B\x08\x02\x03\x02\x01\x01\x04\
...
\x01B\x02\x01w\x04\0\x08duration\x03\0\0\x03\0\x17wasi:clocks/types@0.3.0\x05\x05\
\x02\x03\0\x04\x08duration\x01B\x84\x01\x02\x03\x02\x01\x06\x04\0\x08duration\x03\
\0\0\x01q\x0a\x03get\0\0\x04head\0\0\x04post\0\0\x03put\0\0\x06delete\0\0\x07con\
nect\0\0\x07options\0\0\x05trace\0\0\x05patch\0\0\x05other\x01s\0\x04\0\x06metho\
d\x03\0\x02\x01q\x03\x04HTTP\0\0\x05HTTPS\0\0\x05other\x01s\0\x04\0\x06scheme\x03\
\0\x04\x01ks\x01k{\x01r\x02\x05rcode\x06\x09info-code\x07\x04\0\x11DNS-error-pay\
load\x03\0\x08\x01k}\x01r\x02\x08alert-id\x0a\x0dalert-message\x06\x04\0\x1aTLS-\
alert-received-payload\x03\0\x0b\x01ky\x01r\x02\x0afield-name\x06\x0afield-size\x0d\
\x04\0\x12field-size-payload\x03\0\x0e\x01kw\x01k\x0f\x01q'\x0bDNS-timeout\0\0\x09\
DNS-error\x01\x09\0\x15destination-not-found\0\0\x17destination-unavailable\0\0\x19\
...
TLS-protocol-error\0\0\x15TLS-certificate-error\0\0\x12TLS-alert-received\x01\x0c\
\0\x13HTTP-request-denied\0\0\x1cHTTP-request-length-required\0\0\x16HTTP-reques\
t-body-size\x01\x10\0\x1bHTTP-request-method-invalid\0\0\x18HTTP-request-URI-inv\
alid\0\0\x19HTTP-request-URI-too-long\0\0\x20HTTP-request-header-section-size\x01\
\x0d\0\x18HTTP-request-header-size\x01\x11\0!HTTP-request-trailer-section-size\x01\
\x0d\0\x19HTTP-request-trailer-size\x01\x0f\0\x18HTTP-response-incomplete\0\0!HT\
TP-response-header-section-size\x01\x0d\0\x19HTTP-response-header-size\x01\x0f\0\
\x17HTTP-response-body-size\x01\x10\0\"HTTP-response-trailer-section-size\x01\x0d\
\0\x1aHTTP-response-trailer-size\x01\x0f\0\x1dHTTP-response-transfer-coding\x01\x06\
\0\x1cHTTP-response-content-coding\x01\x06\0\x15HTTP-response-timeout\0\0\x13HTT\
P-upgrade-failed\0\0\x13HTTP-protocol-error\0\0\x0dloop-detected\0\0\x13configur\
ation-error\0\0\x0einternal-error\x01\x06\0\x04\0\x0aerror-code\x03\0\x12\x01q\x05\
\x0einvalid-syntax\0\0\x09forbidden\0\0\x09immutable\0\0\x0dsize-exceeded\0\0\x05\
other\x01\x06\0\x04\0\x0cheader-error\x03\0\x14\x01q\x03\x0dnot-supported\0\0\x09\
immutable\0\0\x05other\x01\x06\0\x04\0\x15request-options-error\x03\0\x16\x01s\x04\
\0\x0afield-name\x03\0\x18\x01p}\x04\0\x0bfield-value\x03\0\x1a\x04\0\x06fields\x03\
\x01\x04\0\x07headers\x03\0\x1c\x04\0\x08trailers\x03\0\x1c\x04\0\x07request\x03\
\x01\x04\0\x0frequest-options\x03\x01\x01{\x04\0\x0bstatus-code\x03\0!\x04\0\x08\
response\x03\x01\x01i\x1c\x01@\0\0$\x04\0\x13[constructor]fields\x01%\x01o\x02\x19\
\x1b\x01p&\x01j\x01$\x01\x15\x01@\x01\x07entries'\0(\x04\0\x18[static]fields.fro\
m-list\x01)\x01h\x1c\x01p\x1b\x01@\x02\x04self*\x04name\x19\0+\x04\0\x12[method]\
fields.get\x01,\x01@\x02\x04self*\x04name\x19\0\x7f\x04\0\x12[method]fields.has\x01\
-\x01j\0\x01\x15\x01@\x03\x04self*\x04name\x19\x05value+\0.\x04\0\x12[method]fie\
lds.set\x01/\x01@\x02\x04self*\x04name\x19\0.\x04\0\x15[method]fields.delete\x01\
0\x01j\x01+\x01\x15\x01@\x02\x04self*\x04name\x19\01\x04\0\x1d[method]fields.get\
-and-delete\x012\x01@\x03\x04self*\x04name\x19\x05value\x1b\0.\x04\0\x15[method]\
fields.append\x013\x01@\x01\x04self*\0'\x04\0\x17[method]fields.copy-all\x014\x01\
@\x01\x04self*\0$\x04\0\x14[method]fields.clone\x015\x01i\x1d\x01f\x01}\x01k7\x01\
i\x1e\x01k9\x01j\x01:\x01\x13\x01e\x01;\x01i\x20\x01k=\x01i\x1f\x01j\0\x01\x13\x01\
e\x01\xc0\0\x01o\x02?\xc1\0\x01@\x04\x07headers6\x08contents8\x08trailers<\x07op\
tions>\0\xc2\0\x04\0\x13[static]request.new\x01C\x01h\x1f\x01@\x01\x04self\xc4\0\
\0\x03\x04\0\x1a[method]request.get-method\x01E\x01j\0\0\x01@\x02\x04self\xc4\0\x06\
method\x03\0\xc6\0\x04\0\x1a[method]request.set-method\x01G\x01@\x01\x04self\xc4\
\0\0\x06\x04\0#[method]request.get-path-with-query\x01H\x01@\x02\x04self\xc4\0\x0f\
path-with-query\x06\0\xc6\0\x04\0#[method]request.set-path-with-query\x01I\x01k\x05\
\x01@\x01\x04self\xc4\0\0\xca\0\x04\0\x1a[method]request.get-scheme\x01K\x01@\x02\
\x04self\xc4\0\x06scheme\xca\0\0\xc6\0\x04\0\x1a[method]request.set-scheme\x01L\x04\
\0\x1d[method]request.get-authority\x01H\x01@\x02\x04self\xc4\0\x09authority\x06\
\0\xc6\0\x04\0\x1d[method]request.set-authority\x01M\x01@\x01\x04self\xc4\0\0>\x04\
\0\x1b[method]request.get-options\x01N\x01@\x01\x04self\xc4\0\06\x04\0\x1b[metho\
d]request.get-headers\x01O\x01o\x027<\x01@\x02\x04this?\x03res\xc1\0\0\xd0\0\x04\
\0\x1c[static]request.consume-body\x01Q\x01@\0\0=\x04\0\x1c[constructor]request-\
options\x01R\x01h\x20\x01k\x01\x01@\x01\x04self\xd3\0\0\xd4\0\x04\0+[method]requ\
est-options.get-connect-timeout\x01U\x01j\0\x01\x17\x01@\x02\x04self\xd3\0\x08du\
ration\xd4\0\0\xd6\0\x04\0+[method]request-options.set-connect-timeout\x01W\x04\0\
.[method]request-options.get-first-byte-timeout\x01U\x04\0.[method]request-optio\
ns.set-first-byte-timeout\x01W\x04\01[method]request-options.get-between-bytes-t\
imeout\x01U\x04\01[method]request-options.set-between-bytes-timeout\x01W\x01@\x01\
\x04self\xd3\0\0=\x04\0\x1d[method]request-options.clone\x01X\x01i#\x01o\x02\xd9\
\0\xc1\0\x01@\x03\x07headers6\x08contents8\x08trailers<\0\xda\0\x04\0\x14[static\
]response.new\x01[\x01h#\x01@\x01\x04self\xdc\0\0\"\x04\0\x20[method]response.ge\
t-status-code\x01]\x01@\x02\x04self\xdc\0\x0bstatus-code\"\0\xc6\0\x04\0\x20[met\
hod]response.set-status-code\x01^\x01@\x01\x04self\xdc\0\06\x04\0\x1c[method]res\
ponse.get-headers\x01_\x01@\x02\x04this\xd9\0\x03res\xc1\0\0\xd0\0\x04\0\x1d[sta\
tic]response.consume-body\x01`\x03\0\x15wasi:http/types@0.3.0\x05\x07\x02\x03\0\x05\
\x07request\x02\x03\0\x05\x08response\x02\x03\0\x05\x0aerror-code\x01B\x0b\x02\x03\
\x02\x01\x08\x04\0\x07request\x03\0\0\x02\x03\x02\x01\x09\x04\0\x08response\x03\0\
\x02\x02\x03\x02\x01\x0a\x04\0\x0aerror-code\x03\0\x04\x01i\x01\x01i\x03\x01j\x01\
\x07\x01\x05\x01C\x01\x07request\x06\0\x08\x04\0\x04send\x01\x09\x03\0\x16wasi:h\
ttp/client@0.3.0\x05\x0b\x01B\x0c\x02\x03\x02\x01\x06\x04\0\x08duration\x03\0\0\x01\
w\x04\0\x04mark\x03\0\x02\x01@\0\0\x03\x04\0\x03now\x01\x04\x01@\0\0\x01\x04\0\x0e\
get-resolution\x01\x05\x01C\x01\x04when\x03\x01\0\x04\0\x0await-until\x01\x06\x01\
C\x01\x08how-long\x01\x01\0\x04\0\x08wait-for\x01\x07\x03\0!wasi:clocks/monotoni\
c-clock@0.3.0\x05\x0c\x01B\x08\x02\x03\x02\x01\x06\x04\0\x08duration\x03\0\0\x01\
r\x02\x07secondsx\x0bnanosecondsy\x04\0\x07instant\x03\0\x02\x01@\0\0\x03\x04\0\x03\
now\x01\x04\x01@\0\0\x01\x04\0\x0eget-resolution\x01\x05\x03\0\x1ewasi:clocks/sy\
stem-clock@0.3.0\x05\x0d\x01B\x05\x01p}\x01@\x01\x07max-lenw\0\0\x04\0\x10get-ra\
ndom-bytes\x01\x01\x01@\0\0w\x04\0\x0eget-random-u64\x01\x02\x03\0\x18wasi:rando\
m/random@0.3.0\x05\x0e\x01B\x05\x01p}\x01@\x01\x07max-lenw\0\0\x04\0\x19get-inse\
cure-random-bytes\x01\x01\x01@\0\0w\x04\0\x17get-insecure-random-u64\x01\x02\x03\
\0\x1awasi:random/insecure@0.3.0\x05\x0f\x01B\x03\x01o\x02ww\x01@\0\0\0\x04\0\x11\
get-insecure-seed\x01\x01\x03\0\x1fwasi:random/insecure-seed@0.3.0\x05\x10\x01B\x0b\
\x02\x03\x02\x01\x08\x04\0\x07request\x03\0\0\x02\x03\x02\x01\x09\x04\0\x08respo\
nse\x03\0\x02\x02\x03\x02\x01\x0a\x04\0\x0aerror-code\x03\0\x04\x01i\x01\x01i\x03\
\x01j\x01\x07\x01\x05\x01C\x01\x07request\x06\0\x08\x04\0\x06handle\x01\x09\x04\0\
\x17wasi:http/handler@0.3.0\x05\x11\x04\0\x17wasi:http/service@0.3.0\x04\0\x0b\x0d\
\x01\0\x07service\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-compone\
nt\x070.253.0\x10wit-bindgen-rust\x060.59.0";
        };
    };
}
#[doc(inline)]
...
#[rustfmt::skip]
#[cfg(target_arch = "wasm32")]
#[cfg_attr(feature = "rustc-dep-of-std", unsafe(link_section = "component-type:wit-bindgen:0.59.0:wasi:http@0.3.0:service-with-all-of-its-exports-removed:encoded worldrust-wasip3-0.7.0+wasi-0.3.0-from-crates-io-service-world-in-libstd"))]
#[cfg_attr(not(feature = "rustc-dep-of-std"), unsafe(link_section = "component-type:wit-bindgen:0.59.0:wasi:http@0.3.0:service-with-all-of-its-exports-removed:encoded worldrust-wasip3-0.7.0+wasi-0.3.0-from-crates-io-service-world"))]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 4933] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xa7%\x01A\x02\x01A\x1d\
\x01B\x02\x01m\x03\x02io\x15illegal-byte-sequence\x04pipe\x04\0\x0aerror-code\x03\
\0\0\x03\0\x14wasi:cli/types@0.3.0\x05\0\x02\x03\0\0\x0aerror-code\x01B\x07\x02\x03\
\x02\x01\x01\x04\0\x0aerror-code\x03\0\0\x01f\x01}\x01j\0\x01\x01\x01e\x01\x03\x01\
@\x01\x04data\x02\0\x04\x04\0\x10write-via-stream\x01\x05\x03\0\x15wasi:cli/stdo\
...
cure-random-bytes\x01\x01\x01@\0\0w\x04\0\x17get-insecure-random-u64\x01\x02\x03\
\0\x1awasi:random/insecure@0.3.0\x05\x0f\x01B\x03\x01o\x02ww\x01@\0\0\0\x04\0\x11\
get-insecure-seed\x01\x01\x03\0\x1fwasi:random/insecure-seed@0.3.0\x05\x10\x04\0\
7wasi:http/service-with-all-of-its-exports-removed@0.3.0\x04\0\x0b-\x01\0'servic\
e-with-all-of-its-exports-removed\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\
